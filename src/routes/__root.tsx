...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ShatterHerLeaders" },
      {
        name: "description",
        content: "Track contributions, earn points and lead with ShatterHer.",
      },
      { name: "author", content: "ShatterHer" },
      { property: "og:title", content: "ShatterHerLeaders" },
      {
